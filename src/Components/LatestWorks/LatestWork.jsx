            ...
            <Conteiner>
                ...
                <div className='flex flex-col sm:flex-row gap-4 sm:gap-[80px] items-center relative mt-11 sm:mt-0'>
                    ...
                    <div className='w-full'>
                        <h3 className='font-button font-bold text-2xl md:text-4xl text-[#373AA0] mt-4 mb-1 md:mt-8 md:mb-[7px]'>Innovate</h3>
                        <span className='font-button text-base md:text-lg text-[#373AA0]'>(Management Tool)</span>
                        <p className='font-button text-justify text-white text-sm md:text-base my-2.5 md:my-4 max-w-[584.594px]'>This project was created React.This is my first project made with React and this is a helpful site for everyone.</p>
                        <ul className='flex flex-wrap font-button text-white my-3.5'>
                            <li className='border border-[#444] py-[5.5px] px-[10px] mb-[6.8px] mr-[6.8px] rounded-[50px] text-sm md:text-base'>#javascript</li>
                            <li className='border border-[#444] py-[5.5px] px-[10px] mb-[6.8px] mr-[6.8px] rounded-[50px] text-sm md:text-base'>#react.js</li>
                            <li className='border border-[#444] py-[5.5px] px-[10px] mb-[6.8px] mr-[6.8px] rounded-[50px] text-sm md:text-base'>#html</li>
                            <li className='border border-[#444] py-[5.5px] px-[10px] mb-[6.8px] mr-[6.8px] rounded-[50px] text-sm md:text-base'>#css</li>
                            <li className='border border-[#444] py-[5.5px] px-[10px] mb-[6.8px] mr-[6.8px] rounded-[50px] text-sm md:text-base'>#tailwind</li>
                            <li className='border border-[#444] py-[5.5px] px-[10px] mb-[6.8px] mr-[6.8px] rounded-[50px] text-sm md:text-base'>#github</li>
                            <li className='border border-[#444] py-[5.5px] px-[10px] mb-[6.8px] mr-[6.8px] rounded-[50px] text-sm md:text-base'>#git</li>
                            <li className='border border-[#444] py-[5.5px] px-[10px] mb-[6.8px] mr-[6.8px] rounded-[50px] text-sm md:text-base'>#figma</li>
                        </ul>
                    </div>
                </div>
                <div className='flex flex-col sm:flex-row-reverse gap-4 sm:gap-[80px] items-center relative mt-11 sm:mt-[58px]'>
                    ...
                    <div className='w-full'>
                        <h3 className='font-button font-bold text-2xl md:text-4xl text-[#2B8761] mt-8 mb-[7px]'>Cleaning</h3>
                        <span className='font-button text-base md:text-lg text-[#2B8761]'>(Digital Marketing Agency)</span>
                        ...
                        <ul className='flex flex-wrap font-button text-white my-3.5'>
                            ...
                            <li className='border border-[#444] py-[5.5px] px-[10px] mb-[6.8px] mr-[6.8px] rounded-[50px] text-sm md:text-base'>#html</li>
                            <li className='border border-[#444] py-[5.5px] px-[10px] mb-[6.8px] mr-[6.8px] rounded-[50px] text-sm md:text-base'>#css</li>
                            <li className='border border-[#444] py-[5.5px] px-[10px] mb-[6.8px] mr-[6.8px] rounded-[50px] text-sm md:text-base'>#bootstrap</li>
                            <li className='border border-[#444] py-[5.5px] px-[10px] mb-[6.8px] mr-[6.8px] rounded-[50px] text-sm md:text-base'>#github</li>
                            <li className='border border-[#444] py-[5.5px] px-[10px] mb-[6.8px] mr-[6.8px] rounded-[50px] text-sm md:text-base'>#git</li>
                            <li className='border border-[#444] py-[5.5px] px-[10px] mb-[6.8px] mr-[6.8px] rounded-[50px] text-sm md:text-base'>#figma</li>
                        </ul>
                ...
                <div className='flex flex-col sm:flex-row gap-4 sm:gap-[80px] items-center relative mt-11 sm:mt-[58px]'>
                    ...
                    <div className='w-full'>
                        <h3 className='font-button font-bold text-2xl md:text-4xl text-[#6A4DF4] mt-8 mb-[7px]'>Agence</h3>
                        <span className='font-button text-base md:text-lg text-[#6A4DF4]'>(Digital Marketing Agency)</span>
                ...
                <div className='flex flex-col sm:flex-row-reverse gap-4 sm:gap-[80px] items-center relative mt-11 sm:mt-[58px]'>
                    ...
                    <div className='w-full'>
                        <h3 className='font-button font-bold text-2xl md:text-4xl text-[#2c3e50] mt-8 mb-[7px]'>BMI Calculator</h3>
                        <span className='font-button text-base md:text-lg text-[#2c3e50]'>(BMI Checker)</span>
                ...
                <div className='flex flex-col sm:flex-row gap-4 sm:gap-[80px] items-center relative mt-11 sm:mt-[58px]'>
                    ...
                    <div className='w-full'>
                        <h3 className='font-button font-bold text-2xl md:text-4xl text-[#f41b75] mt-8 mb-[7px]'>Digital Clock</h3>
                        <span className='font-button text-base md:text-lg text-[#f41b75]'>(Digital Clock)</span>
                        <p className='font-button text-justify text-white my-4 max-w-[584.594px]'>This project was created Bootstrap.This is my second project made with Bootstrap and this is a helpful site for everyone.</p>
                        <ul className='flex flex-wrap font-button text-white my-3.5'>
                            <li className='border border-[#444] py-[5.5px] px-[10px] mb-[6.8px] mr-[6.8px] rounded-[50px] text-sm md:text-base'>#javascript</li>
                            <li className='border border-[#444] py-[5.5px] px-[10px] mb-[6.8px] mr-[6.8px] rounded-[50px] text-sm md:text-base'>#html</li>
